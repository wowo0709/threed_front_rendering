...
cam_path_out=/root/desktop/tmp/3D-FRONT-processed/bedrooms_without_lamps_full_labels
start_idx=0
end_idx=2
...
main_out_dir=/root/desktop/tmp/3D-FRONT-processed/bedrooms_without_lamps_full_raw/raw_256
img_resolution=256
...
do
blenderproc vis hdf5 $main_out_dir --flip=true --keys colors --save $img_out_dir --scene_idx $scene_idx --frame_idx $frame_idx --path_labels $vert_path_out
