...
path_to_output_dir=/root/desktop/3D-FRONT/3D-FRONT-processed/bedrooms_without_lamps
...
path_to_3d_future_model_info=/root/desktop/3D-FRONT/3D-FUTURE-model/model_info.json     # model info w/ wall,l door, lamp, etc.
